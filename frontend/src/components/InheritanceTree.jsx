  ...
  return (
    <svg width="100%" height="200" viewBox="0 0 340 200" fontFamily="Nunito Sans, sans-serif">
      ...
      {[
        ...
        <g key={c.label}>
          <rect x={c.x - 34} y="76" width="68" height="34" rx="10" fill="#fff" stroke={c.color} strokeWidth="2" />
          <text x={c.x} y="98" textAnchor="middle" fontSize="12.5" fontWeight="700" fill="#2b2b2b">
            {c.label}
          </text>
          <text x={c.x} y="126" textAnchor="middle" fontSize="10" fill={c.color} fontWeight="700">
            {c.tag}
          </text>
        </g>
      ))}
