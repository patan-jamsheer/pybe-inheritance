...
const STEPS = [
  {
    badge: "STEP 1 OF 8 · Starting from nothing",
  ...
  {
    badge: "STEP 2 OF 8 · Giving Bird its first habit",
  ...
  {
    badge: "STEP 3 OF 8 · A second habit, same pattern",
    storyQuote: "...sleep...",
  ...
  {
    badge: "STEP 4 OF 8 · Bird is complete",
    storyQuote:
  ...
  {
    badge: "STEP 5 OF 8 · Eagle: reusing everything",
  ...
  {
    badge: "STEP 6 OF 8 · Sparrow: adding something new",
    storyQuote:
      "...she picked up a skill of her own that Bird never had: weaving twigs into a nest.",
    teach:
      "class Sparrow(Bird): again means \"Sparrow is a Bird\" — she gets eat(), sleep(), fly() too. But this time we also write one brand-new method Bird doesn't have at all.",
    codeOld:
      'class Bird:\n    def eat(self):\n        print("pecking at seeds")\n\n    def sleep(self):\n        print("resting on a branch")\n\n    def fly(self):\n        print("gliding through the sky")\n\n\nclass Eagle(Bird):\n    pass',
    codeNew:
  ...
  {
    badge: "STEP 7 OF 8 · Penguin: replacing one habit",
    storyQuote:
  ...
  {
    badge: "STEP 8 OF 8 · Owl: building on top, not replacing",
    storyQuote:
